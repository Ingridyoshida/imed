...
const DateTitleArea = styled.TouchableOpacity`
    width: 140px;
    justify-content: center;
    align-items: center;
`;
        ...
        <ModalArea>
            <ModalBody>
                <CloseButton onPress={handleCloseButton} >
                    <ExpandIcon width="30" height="30" fill="#000000" />
                </CloseButton>
                <ModalItem>
                    <UserInfo>
                ...
                <ModalItem>
                    <DateInfo>
                        <DatePrevArea onPress= {handleLeftDateClick}>
                            <NavPrevIcon width="22" height="22" fill="#000000" />
                        </DatePrevArea>
                        <DateTitleArea>
                            <DateTitle>{months[selectedMonth]} {selectedYear}</DateTitle>
                        </DateTitleArea>
                        <DateNextArea onPress={handleRightDateClick}>
                        <NavNextIcon width="22" height="22" fill="#000000" />
                        </DateNextArea>
                    </DateInfo>
